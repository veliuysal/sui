...
use sui_graphql_rpc::test_infra::cluster::{serve_executor, RetentionPolicies, SnapshotLagConfig};
    ...
    async fn init(
        ...
        let (
            ...
            let retention_policies =
                epochs_to_keep.map(RetentionPolicies::new_with_default_retention_only_for_testing);

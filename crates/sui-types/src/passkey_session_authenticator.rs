...
pub struct PasskeySessionAuthenticator {
    ...
    /// Ephemeral signature that can be of any scheme.
    ...
    /// Maximum epoch that the ephemeral key is valid for.
    max_epoch: EpochId,
...
impl PasskeySessionAuthenticator {
    /// A constructor for [struct PasskeySessionAuthenticator] with custom
...
impl AuthenticatorTrait for PasskeySessionAuthenticator {
        ...
        T: Serialize,
    {
        ...
        let mut expected_register_msg = vec![self.ephemeral_signature.as_ref()[0]];
        ...
        self.passkey_pk
            ...
            .map_err(|_| SuiError::InvalidSignature {
                error: "Fails to verify passkey sig".to_string(),
            })
    }
}
